...
export const COMMITMENT_POLICIES: CommitmentPolicy[] = [
  ...
  {
    id: "policy-counter-1930",
    sku: "SG-0730",
    name: "Chef's counter release",
    item: "Chef's counter · 7:30 PM",
    category: "DINING",
    status: "ACTIVE",
    feeAtomic: "500000",
    durationMinutes: 10,
    ...
    allocationRule: "FIRST_VERIFIED",
    creditOnExercise: true,
    terms: "The commitment secures the counter seat and is credited to the final bill.",
    updatedAt: "Yesterday, 17:16",
  },
  {
    id: "policy-guest-menu",
    sku: "SG-GUEST",
    name: "Guest chef table access",
    item: "Guest chef menu · 7:00 PM",
    category: "DINING",
    status: "DRAFT",
    feeAtomic: "1000000",
    durationMinutes: 5,
    ...
    creditOnExercise: true,
    terms: "Selected buyers receive a five-minute booking window. The fee is credited to dinner.",
    updatedAt: "Aug 14, 21:04",
  },
  {
    id: "policy-brunch-sunday",
    sku: "SG-BR11",
    name: "Weekend brunch table",
    item: "Table for four · Sunday 11:30 AM",
    category: "DINING",
    status: "PAUSED",
    feeAtomic: "2000000",
    durationMinutes: 15,
    ...
    creditOnExercise: true,
    terms: "Subject to merchant approval. The commitment fee is credited to the brunch bill.",
